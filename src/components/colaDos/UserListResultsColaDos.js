...
const UserListResultsColaDos = ({ loading, error, users, usersCola2, ...rest }) => {
      ...
      <PerfectScrollbar>
        ...
        <Box sx={{ minWidth: 500 }}>
          <Table>
            ...
            <TableBody>
              {usersCola2.slice(page * limit, (page + 1) * limit).map(
                (user) =>
...
UserListResultsColaDos.propTypes = {
  users: PropTypes.array.isRequired,
};

export default UserListResultsColaDos;
